...
selection.full2 <- dredge(m.glob.full2, subset= !(SI_sc && mus_perimetro_km_sc) & !(mus_perimetro_km_sc && mus_tamanho_km_sc) & !(mus_perimetro_km_sc && mus_area1_km_sc) & !(out_l11_r3_1km_sc && for_area1_km_sc) & !(out_l11_r3_1km_sc && for_area2_km_sc) & !(out_l11_r3_1km_sc && for_area05_km_sc) & !(for_area2_km_sc && for_area1_km_sc) & !(for_area2_km_sc && for_area05_km_sc) & !(for_area2_km_sc && sm_leng2_km_sc) & !(for_area2_km_sc && sm_leng1_km_sc) & !(for_area1_km_sc && for_area05_km_sc) & !(mus_area2_km_sc && mus_area1_km_sc) & !(mus_area2_km_sc && mus_tamanho_km_sc) & !(mus_area2_km_sc && mus_perimetro_km_sc) & !(mus_area1_km_sc && mus_area05_km_sc) & !(big_leng2_km_sc && big_leng1_km_sc) & !(big_leng1_km_sc && big_leng05_km_sc) & !(sm_leng2_km_sc && sm_leng1_km_sc) & !(sm_leng1_km_sc && sm_leng05_km_sc) & !(mus_area2_km_sc && mus_area05_km_sc) & !(big_leng2_km_sc && big_leng05_km_sc) & !(sm_leng2_km_sc && sm_leng05_km_sc))
